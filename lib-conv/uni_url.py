...
Date: July 2017
Name: uni_url.py
Purpose: Class Encode/Decode with Unicode URL.
...
class CodingUniURL:
    ...
    def encoded(self):
        answer = ''
        for i in self.mystring:
            for k in self.unicode_url:
                if i in self.unicode_url[k]:
                    answer += k
                    break
            else:
                answer += i
